...
-- Users table policies: anyone can read profiles, users can update their own
...
-- Create public_games table for published games
...
-- Function to clean up expired claim tokens (older than 10 minutes)
